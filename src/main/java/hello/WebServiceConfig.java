...
public class WebServiceConfig extends WsConfigurerAdapter {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema orderSchema) {
		...
		wsdl11Definition.setTargetNamespace("http://www.accurate.com/acec/AcecBOSOAIntegration/BOOrderIntegration");
	...
	public XsdSchema orderSchema() {
		return new SimpleXsdSchema(new ClassPathResource("BOOrderIntegration.xsd"));
	}
}
